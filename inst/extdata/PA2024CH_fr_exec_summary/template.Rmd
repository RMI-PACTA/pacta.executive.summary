...
\textbf{Un méta-rapport contenant des données anonymes et agrégées} pour la Suisse de tous les participants, ainsi que des rapports sectoriels, est publié sur le site Internet de l'OFEV \textbf{\href{https://www.bafu.admin.ch/bafu/fr/home/themes/climat/info-specialistes/climat-et-marche-financier.html}{(lien)}}. 122 institutions financières ont participé en 2024, en indiquant le groupe de pairs auquel elles appartiennent, comme les fonds de pension, les assurances, les banques et les gestionnaires d'actifs.
