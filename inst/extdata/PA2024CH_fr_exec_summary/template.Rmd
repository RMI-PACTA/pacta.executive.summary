...
Le score agrégé compare l'alignement de tous les actifs avec les scénarios publiés dans le WEO2023 jusqu'en 2028. Le score est calculé à la fois au niveau du portefeuille agrégé (voir aussi voir aussi les indicateurs selon les "Swiss Climate Scores") et par secteur PACTA.\footnote{Les scénarios climatiques WEO ont été choisis parce qu'ils couvraient le plus de secteurs PACTA. Veuillez noter que les scénarios WEO prévoient une accélération des changements technologiques après les cinq années analysées par PACTA. En tant que tel, votre score global pourrait être inférieur si vous utilisez d'autres scénarios.}
