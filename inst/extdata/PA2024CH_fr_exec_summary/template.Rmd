...
\item Des détails sur l'utilisation des résultats du PACTA à la lumière du protocole de définition des objectifs de la NZAOA sont disponibles dans le guide suivant \textbf{\href{https://pacta.rmi.org/wp-content/uploads/2024/10/Using-PACTA-with-the-NZAOA-Target-Setting-Protocol.pdf}{(lien)}}. 
\end{itemize}
