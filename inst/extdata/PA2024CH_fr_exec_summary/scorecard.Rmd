...
\begin{itemize}
\item L'institution dispose-t-elle d'objectifs intermédiaires concrets pour atteindre l'objectif zéro net d'ici 2050, par exemple pour 2030 ?
\begin{itemize}
...
* Proportion des votes sur les résolutions relatives au climat au cours de l'année écoulée compatibles avec un objectif de zéro net en 2050.
  * Mise en œuvre : Valeur indiquée dans l'enquête qualitative par l'utilisateur.
...
* Score sectoriel, agrégé en un seul score ; le ciment est exclu car il n'est pas couvert par WEO 2023.
