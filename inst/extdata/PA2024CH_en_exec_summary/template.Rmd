...
\item Details on how to use PACTA results in light of the NZAOA target setting protocol, can be found in the following guide \textbf{\href{https://pacta.rmi.org/wp-content/uploads/2024/11/202410__Using-PACTA-with-the-NZAOA-Target-Setting-Protocol.pdf}{(link)}}.
\end{itemize}
