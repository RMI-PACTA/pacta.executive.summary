...
\item Details on how to use PACTA results in light of the target setting protocol, can be found in the following guide “to be defined” (Link) 
\end{itemize}
