...
\begin{tabular}{ p{0.5\linewidth} p{0.5\linewidth} } 
 ...
 \hline
 MSCI World & iShares Global Corp Bond UCITS ETF \\ 
 \hline
\end{tabular}
\end{center}
