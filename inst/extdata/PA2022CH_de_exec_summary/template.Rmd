...
Die PACTA-Analyse deckt acht klimarelevante Sektoren ab: Kohle, Öl & Gas, Elektrizität, Automobilindustrie, Zement, Stahl und Luftfahrt. In der Regel sind die Portfolios von Finanzinstituten wertemässig zu 5-15\% in diesen Sektoren investiert. Die finanzielle Exposition mag zwar gering erscheinen, aber im Durchschnitt sind die Anlagen für einen viel grösseren Anteil der Emissionen verantwortlich. Nachstehend sind die Grafiken eines Beispielportfolios dargestellt: 
