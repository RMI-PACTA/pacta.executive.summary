...
% Using fontenc does seem to fix hypenation but break ß
...
% Using the German package seems to add errors with quotation marks.
% Without it, quotation marks are incorrect, but it builds
