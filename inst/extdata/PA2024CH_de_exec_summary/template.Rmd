...
\end{minipage}%
\begin{minipage}[c]{0.7\textwidth}
\textbf{Klima-Engagement und andere qualitative Indikatoren:} Ergänzung der Analyse mit Informationen über Klimamassnahmen, die einen reellen Einfluss auf das Klima haben können.
\end{minipage}%
...
\section {Anhang (II): Zusätzliche Erläuterungen zum Diagramm - Umfrage zu Klimamaßnahmen}
...
Dies ist ein Beispiel-Zielschreiben-Diagramm für einen Nutzer, der Best-Practices in dem Bereich anwendet, auf den sich das Diagramm bezieht (siehe Titel, in diesem Fall Ausschlussverfahren im Ölsektor).  Alle Kreise sind mit Farben von hell bis dunkel gefüllt und alle Beschriftungen sind positive Aussagen. Das bedeutet, dass der Nutzer alle Strategien und/oder Maßnahmen anwendet, die innerhalb des betreffenden Bereichs als wichtig oder wirksam erachtet werden, beginnend mit dem äußeren Ring, der am wenigsten wirksam (aber dennoch wichtig) ist, bis hin zum inneren Kreis, der am wirksamsten ist. 
