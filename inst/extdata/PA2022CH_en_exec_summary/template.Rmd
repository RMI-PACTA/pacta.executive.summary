...
\begin{esbox}{Only One Param}
This is a textwidth sample.
\end{esbox}

\begin{esbox}[0.5\textwidth]{Cool box title}
This is a 0.5 textwidth sample.
\end{esbox}
\begin{esbox}[0.5\textwidth]{Another neat box}
This is another 0.5 textwidth sample. \\
This is another line \\
This is the next line \\
Okay. \\
This seems like enough lines \\
\end{esbox}

\begin{esbox}[0.25\textwidth]{itty bity box}
This is a 0.25 textwidth sample.
\end{esbox}
\begin{esbox}[0.5\textwidth]{wider box}
This is a 0.5 textwidth sample.
\end{esbox}
\begin{esbox}[0.25\textwidth]{another bitty box}
This is a 0.25 textwidth sample.
\end{esbox}
```
