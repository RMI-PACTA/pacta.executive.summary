...
* Does the financial institution support climate strategies through voting rights?
  ...
  **YES/NO LE (Peers LE [XY] %), YES/NO PE (Peers PE [XY] %), YES/NO INF (Peers [XY] %) YES/NO Other assets (Peers other assers [XY] %)**
...
* Does the financial institution support climate strategies through engagement measures?
  ...
  **YES/NO LE (Peers LE [XY] %), YES/NO CB (Peers CB [XY] %), YES/NO RE (Peers RE [XY] %), YES/NO Other assets (Peers other assers [XY] %)**
