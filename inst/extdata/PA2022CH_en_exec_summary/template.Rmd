...
```{r energy_carrier_real_estate, fig.height = 6, eval = params$real_estate_flag}
...
```{r map_real_estate, fig.height = 6, eval = params$real_estate_flag}
...
```{r co2_intensity_real_estate_portfolio_peers, fig.height = 6, eval = params$real_estate_flag}
knitr::include_graphics(file.path(real_estate_dir, "img", "pa_d_distribtion_de.png"))
# TODO: check if this is the correct placement (d or h)
```

Distribution of the mean CO2 intensity of your mortgage portfolio compared to peers.

```{r co2_intensity_mortgage_portfolio_peers, fig.height = 6, eval = params$real_estate_flag}
knitr::include_graphics(file.path(real_estate_dir, "img", "pa_h_distribtion_de.png"))
# TODO: check if this is the correct placement (d or h)
```
...
```{r emission_reduction_path_real_estate, fig.height = 6, eval = params$real_estate_flag}
...
```{r stranded_assets_real_estate, fig.height = 6, eval = params$real_estate_flag}
