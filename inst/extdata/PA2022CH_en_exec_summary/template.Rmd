...
```{r alignment_table_bonds, out.height='33%'}
if ("bonds" %in% results_portfolio$asset_class) {
...
```{r alignment_table_equity, out.height='33%'}
if ("equity" %in% results_portfolio$asset_class) {
  data_alignment_table <- prep_alignment_table(
    results_portfolio = results_portfolio, 
    peers_results_aggregated = peers_results_aggregated,
    asset_class = "equity"
