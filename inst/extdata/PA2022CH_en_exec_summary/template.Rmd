...
---
title: "Executive Summary `r format.POSIXct(Sys.time(), tz = "CET")` CET"
subtitle:  |  
...
%FIXME: \textbf{(\href{link}{\url{https://www.bafu.admin.ch/bafu/en/home/topics/climate/info-specialists/climate-and-financial-markets.html}})}
...
The analysis of the listed equity and corporate bond portfolios covers 8 climate-relevant sectors*. For these sectors, the exposure as well as the alignment with a pathway to limit global warming well below 1.5 degrees (Paris Agreement) has been analyzed. The trajectory alignment measurement was done using the PACTA method. PACTA compares forward-looking production plans of all invested companies in the PACTA sectors on a technology level to the targets from climate scenarios. For more information on the PACTA methodology, please refer to the PACTA Knowledge Hub \textbf{(\href{link}{\url{https://rmi.gitbook.io/pacta-knowledge-hub/}})}.
...
\raggedleft\footnotesize{* coal mining, oil \& gas extraction, power generation, automotive manufacturing, cement manufacturing, steel manufacturing and aviation}
...
This chart displays the alignment scores both on the aggregate level (left-most bar) and on sector level. The bigger, dark-blue triangle indicates the score obtained by this portfolio and the smaller grey triangle indicates the average peer result. The horizontal line delineates the scores aligned with the 1.8°C pathway (or higher) from those that are not aligned. The 1.8°C pathway matches with the target in the Paris Agreement of limiting global warming to “well below 2°C”. The scores indicate the scenario with which the production plans of the invested companies align. Please refer to the two visualizations below for more information. 
...
Considering joint engagement as a way to increase the efficacy of engagement practices is echoed by literature on the topic and supported by, for example, the NZAOA (Link to report \href{[here]}{\url{https://www.unepfi.org/wordpress/wp-content/uploads/2022/03/NZAOA_The-future-of-investor-engagement.pdf}}). 
...
The PACTA analysis covers 8 climate-relevant sectors: coal mining, oil \& gas production, power generation (fossil and renewable); automotive production (ICE , hybrid, electric), aviation, cement, and steel. Usually, 5-15\% of FI’s portfolios are invested in these sectors. Even though the financial exposure can seem small, the investments still, on average, account for a much larger share of portfolio emissions. Please see the graphs of a sample portfolio below:
...
* External disclosure: Implementing the federal council’s recommendations \href{link}{\url{https://www.sif.admin.ch/sif/en/home/documentation/press-releases/medienmitteilungen.msg-id-85925.html}}) to use comparable and meaningful climate compatibility indicators to help create transparency in all financial products and client portfolios incl. indicators following the Swiss Climate Scores \href{link}{\url{https://www.sif.admin.ch/sif/en/home/swiss-climate-scores/valuation-parameters.html}}.
* Details on how to use the results for reporting according to TCFD, the EU SFDR or EU Taxonomy can be found in the following report "The Disclosure Puzzle – the role of PACTA" (\href{link}{\url{https://2degrees-investing.org/wp-content/uploads/2020/03/PACTA-disclosures-report.pdf}}).

\end{esbox}

\begin{esbox}{Where can I find the full results of this test (interactive report)?}

This Executive Summary serves as a supplement to the comprehensive and interactive presentation of your results in the so-called interactive report. You can view this on the Transition Monitor Platform under "Results" after logging in with your password \textbf{(\href{link}{\url{https://platform.transitionmonitor.com/}})}.

\end{esbox}

\begin{esbox}{Where can I learn more about the PACTA Methodology?}

If you want to learn more about the open-source methodology behind PACTA, you can do so on our "PACTA Knowledge Hub" \textbf{(\href{link}{\url{https://rmi.gitbook.io/pacta-knowledge-hub/}})}.
...
The following three pages of the “Climate Scores” complement the PACTA Executive Summary by showing automatically generated results on portfolio-level, based on the Swiss Climate Scores. As the \href{Swiss Climate Scores}{\url{https://www.sif.admin.ch/sif/en/home/finanzmarktpolitik/sustainable-finance.html}} were defined during the PACTA Climate Test 2022, there are some deviations which are noted on the explanation page. Please note that the indicators on exposure to fossil fuels and the Global Warming Alignment are based on the PACTA methodology and sectors.
...
```{r emissions_scorecard, fig.height=2.5}
