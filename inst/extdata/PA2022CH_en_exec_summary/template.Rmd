...
```{r exposure, fig.height=4.5, fig.width=6, fig.show='hold', out.width='50%'}
tryCatch(
  {
...
```{r alignment_table_equity, fig.height=4, fig.width=6, align='center'}
tryCatch(
  {
    data_alignment_table <- prep_alignment_table(
      results_portfolio = results_portfolio, 
...
Considering joint engagement as a way to increase the efficacy of engagement practices is echoed by literature on the topic and supported by, for example, the NZAOA **([link](https://www.unepfi.org/wordpress/wp-content/uploads/2022/03/NZAOA_The-future-of-investor-engagement.pdf))**.
