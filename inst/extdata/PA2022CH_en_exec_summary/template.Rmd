...
print(data_scatter_power_b)
print(unique(data_scatter_power_b$entity_type))
...
print(data_scatter_power_e)
print(unique(data_scatter_power_e$entity_type))
...
```{r scores, fig.show='hold', out.width='50%', eval = }
