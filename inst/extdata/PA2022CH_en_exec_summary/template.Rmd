...
Distribution of the average CO_2_ intensity of your real estate portfolio (directly held buildings) compared to peers.


Distribution of the mean CO_2_ intensity of your mortgage portfolio compared to peers.
...
```{r real_estate_scores_scorecard, eval = FALS}
# FIXME: Enable
if (real_estate_flag){
