...
gridExtra::grid.arrange(pacta.executive.summary::rasterGrob(plot_bo_c_survey), plot_bo_c_exp, pacta.executive.summary::rasterGrob(plot_eq_c_survey), plot_eq_c_exp, ncol=4)
```
...
gridExtra::grid.arrange(pacta.executive.summary::rasterGrob(plot_bo_og_survey), plot_bo_og_exp, pacta.executive.summary::rasterGrob(plot_eq_og_survey), plot_eq_og_exp, ncol = 4)
```
