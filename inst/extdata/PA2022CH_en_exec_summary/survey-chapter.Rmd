...
plot_bo_c_survey <- pacta.executive.summary::readPNG(
  file.path(survey_dir, language, "plot_layer_asset_exclusion_coal_Corporate_bonds.png")
  )
...
plot_eq_c_survey <- pacta.executive.summary::readPNG(file.path(survey_dir, language, "plot_layer_asset_exclusion_coal_Listed_equities.png"))
...
pacta.executive.summary::grid.arrange(pacta.executive.summary::rasterGrob(plot_bo_c_survey), plot_bo_c_exp, pacta.executive.summary::rasterGrob(plot_eq_c_survey), plot_eq_c_exp, ncol=4)
```
...
plot_bo_og_survey <- pacta.executive.summary::readPNG(file.path(survey_dir, language, "plot_layer_asset_exclusion_oil_Corporate_bonds.png"))
...
plot_eq_og_survey <- pacta.executive.summary::readPNG(file.path(survey_dir, language, "plot_layer_asset_exclusion_oil_Listed_equities.png"))
...
pacta.executive.summary::grid.arrange(pacta.executive.summary::rasterGrob(plot_bo_og_survey), plot_bo_og_exp, pacta.executive.summary::rasterGrob(plot_eq_og_survey), plot_eq_og_exp, ncol = 4)
```
