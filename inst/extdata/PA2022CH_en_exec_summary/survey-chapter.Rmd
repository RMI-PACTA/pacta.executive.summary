...
\begin{esbox}{Overview}[engagement]
...
\begin{esbox}{Investee engagement per sector}[engagement]
...
```{r plot_layer_with_peer_info_engagement, out.height='30%', out.width='33%'}
...
\begin{esbox}{Negative screening vs. fossil fuel PACTA exposure}[engagement]
